...
import com.withliyh.mylib.http.GsonPostRequest;
...
public class ApiRequest {
    ...
    public static GsonPostRequest<MeiZiTu> getMeiZiTuRequest(
            final Response.Listener<MeiZiTu> listener,
            final Response.ErrorListener errorListener) {
        return new GsonPostRequest<>(url, MeiZiTu.class, listener, errorListener);
    }

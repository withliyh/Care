...
package com.withliyh.mylib.tabstrip;
...
//		a.recycle();
        ...
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_tabTextColor2, indicatorColor);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            Log.d("PageListener", "onPageScrolled:position=" + position + " positionOffset=" + positionOffset + " positionOffsetPixels=" + positionOffsetPixels);
        ...
        public void onPageScrollStateChanged(int state) {
            Log.d("PageListener", "onPageScrollStateChanged:state=" + state);
        ...
        public void onPageSelected(int position) {
            Log.d("PageListener", "onPageSelected:position=" + position);
